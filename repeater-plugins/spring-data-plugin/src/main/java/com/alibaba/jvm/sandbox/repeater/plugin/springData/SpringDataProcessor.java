 ...
 * @Date 2023/3/9 17:58
 */
public class SpringDataProcessor extends DefaultInvocationProcessor {

    public SpringDataProcessor(InvokeType type) {
        super(type);
    }
    ...
    public Identity assembleIdentity(BeforeEvent event) {
        ...
        String url = String.format("%s://%s", InvokeType.SPRING_DATA.name(), array[array.length-1]);
