 ...
 * @Date 2023/3/9 17:58
 */
public class SpringCacheProcessor extends DefaultInvocationProcessor {

    public SpringCacheProcessor(InvokeType type) {
        super(type);
    }
    ...
    public Identity assembleIdentity(BeforeEvent event) {
        ...
        String url = String.format("%s://%s", InvokeType.SPRING_CACHE.name(), array[array.length-1]);
